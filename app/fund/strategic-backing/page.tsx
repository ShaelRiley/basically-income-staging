...
export default function StrategicBackingPage() {
  return <PageShell>
    ...
    <CtaBand eyebrow="One institution" title="Strategic depth without donor rule." body="Backers receive decision-quality information and accountable stewardship. The PAC retains judgment over campaign selection, endorsements, and allocation." primary={<a className="button button-cream" href="mailto:contact@basicallyincome.org?subject=Strategic%20briefing%20request">Request a Briefing</a>} secondary={<ButtonLink href="/candidates#record" variant="outline">Inspect the Record</ButtonLink>} />
  </PageShell>;
}

...
export default function BillTrackerPage() {
  return <PageShell>
    <PageHero
      ...
      visual={{src: "/community-abundance.webp", alt: "Families and neighbors sharing a flourishing public life", caption: "Legislation is consequential when its human stakes remain visible.", tone: "navy"}}
